...
import { LayoutGrid, User, Coins } from 'lucide-react'

interface NavbarProps { nombre?: string; apellido?: string; email?: string }
...
export default function Navbar({ nombre, apellido, email }: NavbarProps) {
    ...
    <>
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
        <div className="container flex h-14 items-center gap-4">
          ...
          {/* Desktop right — avatar + nombre completo + theme toggle */}
          ...
          {/* Mobile: theme toggle al extremo derecho */}
